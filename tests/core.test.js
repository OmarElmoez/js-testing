...
import { canDrive, failedFetchData, fetchData, getCoupons, isPriceInRange, isValidUsername, Stack, validateUserInput } from "../src/core";
...
describe('failedFetchData', () => {
  it('should return a rejected promise with a reason', async () => {
    try {
      const result = await failedFetchData();      
    } catch (error) {
